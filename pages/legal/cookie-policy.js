      ...
      <section className="container text-black mt-36">
        ...
        <section className="mt-10 mb-20">
          ...
          <p className="mt-4 ml-10">
            ...
            на movexbulgaria@gmail.com. Ние ще отговорим на вашето искане в
          ...
          <p className="mt-4 ml-10">
            ...
            имейл до нашия служител по жалбите на Movex, drujba 2, имейл:
            movexbulgaria@gmail.com. Ние ще отговорим на вашите опасения в
            съответствие с приложимото законодателство.
          </p>
        </section>
      </section>

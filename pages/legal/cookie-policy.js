...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>cargomove Bulgaria - Политика за бисквитките</title>

        <meta name="robots" content="noindex, nofollow" />
        <meta
          name="description"
          content="Политика на бисквитките ни. Запознайте се как ние използваме и обработваме предоставени данните. За контакти - cargomovebg@gmail.com"
        />
      </Head>
      <section className="container text-black mt-48">
        ...
        <section className="mt-10 mb-20">
          <p>
            Тази Политика за поверителност описва политиките на cargomove LTD,
            имейл: cargomovebg@gmail.com, телефон: +359 89 506 3670 относно
            събирането, използването и разкриването на вашата информация, която
            събираме, когато използвате нашия уебсайт ( https://cargomove.bg ).
          ...
          <p className="mt-4 ml-10">
            ...
            на cargomovebg@gmail.com. Ние ще отговорим на вашето искане в
          ...
          <p className="mt-4 ml-10">
            ...
            имейл до нашия служител по жалбите на cargomove, drujba 2, имейл:
            cargomovebg@gmail.com. Ние ще отговорим на вашите опасения в
            съответствие с приложимото законодателство.
          </p>
        </section>
      </section>

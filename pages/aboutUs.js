    ...
    <>
      <Head>
        ...
        <meta
          ...
          content={`Добре дошли в нашата страница за хамалски
           и транспортни услуги "За нас". 
           Ние сме екип от отдадени професионалисти, 
           ангажирани да предоставят изключителни хамалски и транспортни услуги на нашите клиенти. 
           С дългогодишен опит в индустрията, ние усъвършенстваме нашите умения и опит, за да гарантираме,
            че вашето преместване е безпроблемно и без стрес. Ние разбираме важността на надеждното и ефективно обслужване и се стремим да надминем вашите очаквания. 
            Свържете се с нас днес, за да научите повече за това как можем да помогнем при следващото Ви преместване.`}
        />
      </Head>
            ...
            <div className="p-10 border-blue-100 border-y flex-center max-md:order-2">
              <div className="flex-col flex-center">
                ...
                <p className="mt-2 text-sm text-center md:max-w-sm ">
                  В „Мувекс България“ имаме ясна визия за това, къде искаме да
                  стигнем и как да стигнем там. Вярваме, че като си поставяме
                  амбициозни цели и работим усилено за постигането им, можем да
                  се подобряваме и растем като компания. Нашата визия ни кара да
                ...
                <ol className="flex flex-col max-w-md gap-2 mt-2 text-sm list-decimal">
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      постижения. Изграждането на положителна и подкрепяща
                      работна среда, която насърчава нашите служители и
                      стимулира бизнес успеха. Работата в екип прави мечтата да
                      работи.
                    </p>
                  </li>
                  <li>

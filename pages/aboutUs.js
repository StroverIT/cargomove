      ...
      <section className="relative z-20 pt-20 bg-white smToXl:container xl:mx-80 ">
        <div className="flex-col flex-center">
          ...
          <p className="max-w-xl mt-5 text-center">
            Да станем предпочитаната компания за всеки нуждаещ се от преместване
            в страната и чужбина – прилагайки иновативни практики, качествени
            услуги и решения. Да осигурим ефективно преместване на нашите
            клиенти и най-доброто изживяване от прехода към новото си място. С
            помощта на нашите всеотдайни професионалисти да създадем устойчивост
            за растеж на бизнеса и обществото. Позволете да помогнем на вас за
            един плавен преход без стрес.
          </p>
        </div>
          ...
          <div className="p-10 border-orange-100 border-y flex-center max-md:order-2">
            <div className="flex-col flex-center">
              ...
              <p className="mt-2 text-sm text-center md:max-w-sm ">
                ...
                амбициозни цели и работим усилено за постигането им, можем да се
                подобряваме и растем като компания. Нашата визия ни кара да
                предоставяме най-добрите хамалски и транспортни услуги на
                клиентите и да бъдем водещият избор за всеки, който се нуждае от
                качествено и надеждно преместване.
              </p>
            </div>
          </div>
              ...
              <ol className="flex flex-col max-w-md gap-2 mt-2 text-sm list-decimal">
                <li>
                  ...
                  <p>
                    ...
                    нашите клиенти и обществото. Да бъдем ангажирани, отговорни
                    и почтени към вас е наш приоритет и ценност.
                  </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p>
                    ...
                    постижения. Изграждането на положителна и подкрепяща работна
                    среда, която насърчава нашите служители и стимулира бизнес

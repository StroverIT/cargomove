        ...
        <section className="font-sans">
          ...
          <section className="text-center flex-center">
            <p className="lg:max-w-lg">
              ...
              покъщина. Както и необходимостта от придобиване на документи за
              някои от вещите
            </p>
          </section>
          ...
          <p className="mt-1 lg:max-w-3xl">
            Когато не желаете сами да пресмятате обеми и да се притеснявате за
            опаковането. Когато желаете собствеността Ви да пристигне навреме и
            с гаранция за качество. Когато решите да преместите своето имущество
            във всяка страна от ЕС.
          </p>
          <h3 className="mt-2 text-xl font-medium">Какво предлагаме:</h3>
          <p className="mt-1 lg:max-w-3xl">
            Дългогодишен опит с масивно международно преместване и транспорт,

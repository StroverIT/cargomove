...
export default function OfficeMoving() {
  return (
    <>
      <Head>
        <title>Movex Bulgaria - Преместване на офис/корпорация</title>
        <meta
          name="description"
          content={`Movex Bulgaria предлага услугата "Преместване на офис/корпорация" | Бизнес пренасяне на вещи, мебели | Опаковане, демонтаж и монтаж  ☎️ +359 89 506 3670 `}
        />
      </Head>
        ...
        <section className="container font-sans">
          ...
          <section className="lg:px-56">
            ...
            <p className="lg:max-w-5xl">
              ...
              от професионалисти. Ние високо ценим клиентите си , затова държим
              да обърнем внимание към детайлите и да бъдем максимално ефективни
              с нашите услуги.
            </p>
            ...
            <p className="lg:max-w-5xl">
              ...
              фиксирана цена без промяна. Издаване на приемо-предавателен
              протокол за преместените вещи без нанесени щети преместени в
              уговорения срок. Предпочитан начин на плащане след извършена
              работа е по банков път.
            </p>
          </section>

...
export default function OfficeMoving() {
  return (
    <>
      <Head>
        <title>Movex Bulgaria - Преместване на офис</title>
        <meta
          name="description"
          ...
          <section className="">
            <section className="container lg:px-56">
              ...
              <section className="lg:max-w-5xl">
                ...
                <p className="pt-1">
                  Ние предлагаме услуги за преместване на офис в кратък срок,
                  така че да минимализираме усилията на вашия бизнес.
                </p>
                <p className="pt-1">

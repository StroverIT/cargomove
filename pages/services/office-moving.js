              ...
              <section className="container px-5 py-10 bg-white rounded-lg md:px-14">
                ...
                <section className="lg:max-w-5xl">
                  ...
                  <p>
                    ...
                    стресираща задача. Ние от “CargoMove” разбираме
                ...
                <p className="lg:max-w-5xl">
                  ...
                  от професионалисти. В CargoMove имаме изпитан и тестван подход
                  към преместването на офиса. Строгите практики за подбор на
                  персонал, позволяват на нас да предоставим възможно

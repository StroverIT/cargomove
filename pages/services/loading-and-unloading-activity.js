...
export default function CleaningOfApartmentsAndHouses() {
  return (
    <>
      <Head>
        <title>Movex Bulgaria - Товаро-разтоварни дейности</title>
        <meta
          name="description"
          content={`Movex Bulgaria предлага услугата "Товаро-разтоварни дейности". Товаро-разтоварване на тирове и контейнери в складови бази и много други .Разтоварване, приемане за съхранение в открити площи или складове.`}
        />
      </Head>

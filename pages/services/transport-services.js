        ...
        <section className="container font-sans">
          ...
          <section className="lg:px-56">
            ...
            <p className="mt-4 lg:max-w-3xl">
              ...
              доверени партньори, за да поддържа вашите разнообразни нужди от
              доставки и товарен транспорт. Комбинацията от опит и обхват
              предоставя на вас гарантирана висококачествена транспортна услуга
              в рамките на страната и ЕС.
            </p>
            <p className="mt-4 lg:max-w-3xl">
              За нас успешната спедиция не означава само доставен товар, а
              именно внимание към детайлите. Стремим се да доставим възможно
              най-добрите услуги и решения. Нашия опит и превантивните мерки,
              предотвратяват потенциални проблеми при транспортирането на
              товари.
            </p>
            <p className="mt-4 lg:max-w-3xl">
            ...
            <p className="mt-4 lg:max-w-3xl">
              ...
              отпътуване на групажните товари става всеки вторник и доставянето
              на товарите всеки четвъртък. Необходимо е предварително запитване,
